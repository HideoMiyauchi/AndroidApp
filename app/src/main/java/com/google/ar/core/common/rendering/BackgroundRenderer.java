...
public class BackgroundRenderer {
  ...
  // Shader names.
  private static final String CAMERA_VERTEX_SHADER_NAME = "FlightSimulationWithARCore/shaders/screenquad.vert";
  private static final String CAMERA_FRAGMENT_SHADER_NAME = "FlightSimulationWithARCore/shaders/screenquad.frag";
  private static final String DEPTH_VISUALIZER_VERTEX_SHADER_NAME =
      "FlightSimulationWithARCore/shaders/background_show_depth_color_visualization.vert";
  private static final String DEPTH_VISUALIZER_FRAGMENT_SHADER_NAME =
      "FlightSimulationWithARCore/shaders/background_show_depth_color_visualization.frag";
