...
public class ObjectRenderer {
  ...
  // Shader names.
  private static final String VERTEX_SHADER_NAME = "FlightSimulationWithARCore/shaders/ar_object.vert";
  private static final String FRAGMENT_SHADER_NAME = "FlightSimulationWithARCore/shaders/ar_object.frag";
