...
public class PlaneRenderer {
  ...
  // Shader names.
  private static final String VERTEX_SHADER_NAME = "FlightSimulationWithARCore/shaders/plane.vert";
  private static final String FRAGMENT_SHADER_NAME = "FlightSimulationWithARCore/shaders/plane.frag";
